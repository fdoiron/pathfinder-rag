...
class Settings(BaseSettings):
    ...
    chunk_max_tokens: PositiveInt = 800
    chunk_overlap: NonNegativeInt = 0  # 0 disables the carry between windows
    ...
    rerank_prompt_path: Path | None = None  # override for reranking.DEFAULT_INSTRUCTION. Mainly parameter for sweeps
    ...
    hybrid_candidate_pool: PositiveInt = 100  # candidates each arm contributes to the RRF fusion
