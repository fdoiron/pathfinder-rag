...
pathfinder-complete-character-chronicles-druid
...
Animal Companions only have specific magic item slots available to them. Their magic item slots are based on their general body form. The table can be found here.
...
| --- | --- | --- | --- | --- |
| Allosaurus | M |  | Forest (warm), Plains (warm) | PRG:B2 |
| Amargasaurus | M |  | Forest (warm), Plains (warm) | PRG:B6 |
| Ankylosaurus | M |  | Forest (warm), Plains (warm) | PRG:B1 |
| Ant, giant | S |  | Any | PZO1117 |
| Antelope | S |  | Plains (temperate, warm) | PRG:B3 |
| Ape | M | Megaprimatus | Forest (warm) | PZO1110 |
| Archelon | M |  | Coastlines (warm, temperate), Water (warm, temperate) | PRG:B3 |
| Arsinoitherium | M |  | Plains (temperate) | PRG:B2 |
| Aurochs | M | Buffalo or bison | Plains (cold, temperate) | PRG:B1 |
| Axe beak | M |  | Plains (temperate) | PRG:B3 |
| Baboon | S |  | Forest (warm) | PRG:B2 |
| Badger1 | S | Wolverines | Forest (temperate) | PZO1110 |
| Baluchitherium | M |  | Forest (warm) | PRG:B3 |
| Barbed ram | S |  | Mountains (cold) | PAP91 |
| Basilosaurus | M |  | Ocean (any) | PRG:B3 |
| Bat, dire | M |  | Any Terrain (temperate, warm) | PRG:B1 |
| Bear | S |  | Forest (cold) | PZO1110 |
| Beetle, giant | S |  | Any | PZO1117 |
| Bird1 | S | Any large birds such as eagles, hawks or owls | Mountains (temperate) | PZO1110 |
| Blackwisp egret | S |  | Swamps (temperate) | PAP91 |
| Boar3,4 | S |  | Forest (temperate) | PZO1110 |
| Brachiosaurus | M |  | Forest (warm), Plains (warm) | PRG:B1 |
| Bristle boar | S |  | Plains or Hills | Orcs |
| Brontotherium | M |  |  | PRG:B6 |
| Bull, war | M |  | Plains or Hills | Orcs |
| Camel1,2,4 | L |  | Desert (warm) | PZO1110 |
| Cat, big | M | Lions, tigers | Plains (warm), Forest (cold) | PZO1110 |
| Cat, Small1 | S | Cheetahs, leopards | Plains (warm), Forest (warm) | PZO1110 |
| Centipede, giant | S |  | Forests or Underground (temperate or warm) | PZO1117 |
| Chalicotherium | M |  | Forests (temperate) | PAP91 |
| Chameleon, giant | M |  | Forest (warm), Mountains (warm) | PRG:B3 |
| Cooshee | S |  | Forest (any) | FF |
| Crab, giant | S |  | Any aquatic | PZO1117 |
| Crocodile | S | Alligators | Rivers/Lakes (Swamp (warm)) | PZO1110 |
| Deinonychus | S | Velociraptors | Forest (warm) | PZO1110 |
| Deinotherium | M |  | Forests or plains (any climate) | PRG:B6 |
| Devil Monkey | M |  |  | PRG:B6 |
| Dimetrodon | M |  | Forest (warm) | PRG:B3 |
| Dimorphodon | S |  | Coastline or Forest (warm) | PRG:B4 |
| Diplodocus | M |  | Plains (warm) | PRG:B4 |
| Dog1,3,4 | S |  | Any | PZO1110 |
| Dolphin | M |  | Ocean (cold, temperate, warm) | PRG:B1 |
| Drake | T | Drakes | Any | PZO9470 |
| Dunkleosteus | M |  | Ocean (cold, temperate, warm) | PRG:B6 |
| Eel, electric | S |  | Warm fresh water | PRG:B1 |
| Elasmosaurus | M |  | Ocean (warm) | PRG:B1 |
| Elasmotherium | M |  |  | PRG:B6 |
| Elephant | M | Mastodons or mammoths | Plains (warm) | PRG:B1 |
| Elk | M |  | Plains (temperate, cold) | PRG:B3 |
| Embolotherium | M |  | Forests (temperate), Plains (temperate) | PAP91 |
| Faerie Mount | S |  | Forests (temperate), Hills (temperate), Plains (temperate) (Fey World) |  |
| Frog, giant | M | Frog father, goliath frog | Swamp (temperate, warm) | PRG:B1 |
| Gar | M |  | Marshes and Aquatic (temperate, warm) | PRG:B2 |
| Gecko, giant | S |  | Forest (warm), Mountains (warm) | PRG:B3 |
| Giganotosaurus | M |  | Forest (warm) ,Plains (warm) | PRG:B6 |
| Giraffe | M |  | Plains (warm) | PRG:B4 |
| Goblin dog | S |  | Forest (temperate), Swamp (temperate), Underground | PRG:B1 |
| Gylptodon | M |  | Plains (temperate) | PRG:B2 |
| Heron, yolubilis | M |  | Rivers and swamps (temperate) | PAP97 |
| Hippopotamus | M |  | Rivers (warm) | PRG:B2 |
| Horse1,2,4 | L |  | Plains (temperate) | PZO1110 |
| Hyena | S |  | Plains (warm) | PRG:B1 |
| Iguanodon | M |  | Forest (warm), Swamp (warm) | PRG:B3 |
| Kangaroo | M |  | Hills (temperate), Plains (temperate) | PRG:B3 |
| Kentrosaurus | M |  | Plains (warm) | PRG:B6 |
| Llama | S |  | Hills, Mountains (cold or temperate) | AnA |
| Leech, giant | S |  | Marsh (temperate or warm) | PZO1117 |
| Manta ray | M |  | Ocean (warm) | PRG:B2 |
| Mantis, giant | M |  | Forest (temperate) | PZO1117 |
| Megalania | M |  | Forest (warm), Plains (warm) | PRG:B3 |
| Megaloceros | M | Giant elk | Forest (temperate, warm), Plains (temperate) | PRG:B2 |
| Megatherium | M |  | Forest (temperate, warm) | PRG:B2 |
| Mokele-Mbembe | M |  | Lake (warm), River (warm) | PRG:B6 |
| Monitor lizard | S |  | Forest (warm), Plains (warm) | PRG:B1 |
| Moose | M |  | Forest (cold) | AnA |
| Moray eel, giant | M |  | Ocean (warm) | PRG:B1 |
| Octopus | S |  | Ocean (cold, temperate) | PRG:B1 |
| Orca | M | Killer whales | Ocean (cold) | PRG:B1 |
| Ostrich | S |  | Deserts or plains (warm) | OLP |
| Pachycephalosaurus | M |  | Plains (warm, temperate) | PRG:B3 |
| Panda | S |  | Jungle (temperate or warm) | AnA |
| Parasaurolophus | M |  | Forest (warm), Plains (warm) | PRG:B2 |
| Pony1,2,4 | M |  | Plains (temperate) | PZO1110 |
| Pteranodon | M |  | Coastline | PRG:B1 |
| Quetzalcoatlus | M |  | Coastline, swamps, or plains (warm) | PRG:B6 |
| Ram | S |  | Mountains (temperate) | PRG:B2 |
| Rat, dire | S |  | Urban | PRG:B1 |
| Raven, giant | S |  | Any (temperate) | PRG:B6 |
| Rhinoceros | M |  | Plains (warm) | PRG:B1 |
| Roc | M |  | Mountains (warm) | PRG:B1 |
| Scorpion, giant | M |  | Deserts, forests, plains, or underground (warm or temperate) | PZO1117 |
| Seahorse | L |  |  | PRG:B4 |
| Shark1 | S |  | Ocean (cold, temperate, warm) | PZO1110 |
| Shrike, impaler | S |  | Any (temperate) | PAP97 |
| Skittergoat | S |  | Hills or plains (temperate) | PAP91 |
| Slug, giant | M |  | Marshes or Underground (temperate or warm) | PZO1117 |
| Snake, constrictor1 | M | Any kind of constrictor snake | Rivers/Lakes, Swamp (warm), Forest (warm) | PZO1110 |
| Snake, viper1 | S | Any kind of poisonous snake | Any Terrain (temperate, warm) | PZO1110 |
| Snapping turtle | M |  | Coastline, Rivers/Lakes, Swamp (temperate, warm) | PRG:B2 |
| Spider, giant | S |  | Any (warm) | PZO1117 |
| Spinosaurus | M |  | Forest (warm), Swamp (warm) | PRG:B3 |
| Squid | M |  | Ocean (cold, temperate, warm) | PRG:B1 |
| Stag | S |  | Forest (temperate) | PRG:B4 |
| Stegosaurus | M |  | Plains (warm) | PRG:B1 |
| Stingray | S |  | Ocean (warm) | PRG:B2 |
| Styracosaurus | M |  | Plains (warm) | PRG:B4 |
| Thylacine | S |  | Hills (warm) | PRG:B3 |
| Titanoboa | M |  | Swamp (warm) | PRG:B6 |
| Toad, giant | M |  | Forest (temperate), Plains (temperate, warm), Swamp (warm) | PRG:B2 |
| Tortoise | M |  |  | PRG:B4 |
| Triceratops | M |  | Plains (warm) | PRG:B1 |
| Trumpeter Swan | S |  | Lake (temperate), Swamp (temperate) | PRG:B4 |
| Tylosaurus | M |  | Ocean (warm), Rivers/Lakes | PRG:B2 |
| Tyrannosaurus | M |  | Forest (warm), Plains (warm) | PRG:B1 |
| Vulture, giant | M |  | Plains (warm), Hills (warm) | PRG:B3 |
| Vulture, whisper | S |  | Mountain (temperate) | Orcs |
| Walrus | M |  | Coastlines (cold) | AnA |
| Warcat | M |  | Hills (cold), Mountains (cold) | Orcs |
| Wasp, giant | M |  | Forests (temperate) | PZO1117 |
| Weasel, giant | S |  | Any land | PRG:B4 |
| Wolf1,2 | M |  | Any, Forest (temperate) | PZO1110 |
| Wolliped | M |  | Hills (temperate) | PAP70 |
...
***Blood Rage** When a ceratosaurus takes damage in combat, on its next turn it can fly into a rage as a free action. It gains +2 Constitution and +2 Strength, but takes a –2 penalty to its AC. The rage lasts as long as the battle or 1 minute, whichever is shorter. It cannot end its rage voluntarily.
...
* An arctic dire fox gains an additional +4 racial bonus to Stealth in snowy environments.
...
Method-injury (bite); *save* fortitude, Con-based DC; *onset* 1d3 days; *frequency* 1/day; *effect* 1d3 Dex damage and 1d3 Con damage; *cure* 2 consecutive saves

Lesser Compression (Ex)

A dire raccoon can move through an area as small as one-half its space without squeezing or onequarter its space when squeezing.
...
On a successful bite attack against an opponent it’s flanking or that is denied its Dexterity bonus to AC, a jackal deals 1 additional point of damage.
...
A dire corgi, despite its size and ferocity, is really cute. It considers Diplomacy as a class skill and may make Diplomacy checks in any social situation as an innate trick. Additionally, any time their master uses the Diplomacy skill, the dire corgi automatically attempts an Aid Another check, even if they are rolling their own Diplomacy attempt.
...
A giant hamster can try to stuff a grabbed opponent of two sizes smaller than itself into its cheek pouch by making a successful grapple check. A creature stuffed into the giant hamster’s cheek pouch takes no damage, and can escape by making a successful Strength check or can cut its way out by using a light slashing or piercing weapon to deal 10 points of damage to the cheek (AC equal to 10 + ½ the giant hamster’s natural armor). Once the creature exits, muscular action closes the hole; another trapped opponent must cut its own way out. A Medium-sized giant hamster can hold 1 Tiny, 2 Diminutive or 8 Fine creatures in its pouch. A Largesized giant hamster can hold 1 Small, 2 Tiny or 8 Diminutive or smaller creatures in its pouch. The Strength check DC is Strength-based.
...
Any creature attacking a giant porcupine with light or one-handed melee weapons or with melee natural weapons, or an unarmed strike takes 1d3 piercing damage. A creature that grapples a giant porcupine takes 2d4 piercing damage each round it does so. This damage does not apply if the porcupine grapples a creature.
...
A creature that is bit by a hyaenodon must make a Fortitude *save* or suffer a -1 penalty on attack rolls, damage rolls and Strength– or Dexterity-based skills and checks until they receive healing or they recover the damage dealt by the hyaenodon’s bite naturally. The *save* DC is Strength-based.
...
**Ability Scores** **Str** 10, **Dex** 17, **Con** 12, **Int** 2, **Wis** 14, **Cha** 6
...
A hypersloth can act as though under the effect of a haste spell for a number of rounds per day equal to its Hit Dice. These rounds can be broken up over multiple uses or used all at once.
...
**Ability Scores** **Str** 15, **Dex** 16, **Con** 13, **Int** 2, **Wis** 12, **Cha** 6
...
An onwu azu can launch itself into the air and glide for up to 1 minute (depending on the water and weather conditions [GM’s discretion]). When gliding, it has a fly speed of 60 feet with clumsy maneuverability and gains Flyby Attack.
...
**Ability Scores** **Str** 12, **Dex** 10, **Con** 17, **Int** 2, **Wis** 12, **Cha** 6
...
A dire pangolin’s scales come to fine slicing edges. A creature that strikes a dire pangolin while it is taking a total defense action with a melee weapon, an unarmed strike, or a natural weapon takes 1d8 + Strength modifier points of slashing damage. Melee weapons with reach do not endanger a user in this way.
...
**Ability Scores** **Str** 12, **Dex** 17, **Con** 12, **Int** 2, **Wis** 12, **Cha** 4
...
The hooves are primary attacks.

### Aberration Companions

#### Akata

**Prerequisite(s)**: Elder Voice feat, Knowledge (planes) 5

**Note** This companion is available if the Elder Voice feat is taken. The 11th-level mastery benefit is given if the character takes the Elder Voice Mastery feat. Both can be found in Legendary Companions by Legendary Games.
...
Akatas cannot hear. They are immune to spells or effects that rely on hearing but they also cannot make Perception checks to listen.

Salt Water Vulnerability (Ex)

Salt water acts as an acid to akatas. A splash of salt water deals 1d6 points of damage, and full immersion in salt water deals 4d6 points of damage per round.

Void Bite (Ex)

Akatas have a multitude of invisible young within their mouths, spreading to hosts through their bites. Only humanoids make suitable hosts for the akata larvae. All other creatures are immune to this disease.

Disease (Ex)

Void Death: Bite-injury; *save* Fortitude, Con-based DC; *onset* 1 hour; *frequency* 1/day; *effect* 1d2 Dex and 1d2 Con damage. An infected creature that dies rises as a void zombie 2d4 hours later; *cure* 2 consecutive saves.
...
The bogwid’s touch is disgusting. Creatures hit by its slam attack must succeed at a Fortitude save or be nauseated for 1 round. The save DC is Constitution-based.

Revolting Aura (Ex)

The bogwid is both visually and odoriferously revolting. Any creature within 10 feet of a bogwid must succeed at a Fortitude save or be sickened. This effect persists as long as the creature is within the aura and for 2 rounds thereafter. A creature that successfully saves is not subject to the same bogwid’s revolting aura for 24 hours. The save DC is Constitution-based.

Ravenous Young (Ex)

Each round, a bogwid can launch one of the offspring clinging to its back at a target within 10 feet as a ranged touch attack. On a successful hit, the offspring attaches itself to the target and begins draining blood, automatically dealing 1d2 points of bleed damage each round (and possibly infecting the target with bogwid fever, see below). As a full-round action, a creature can attempt to remove one of these offspring, either by bludgeoning it with a fist or pulling it off. Either way, removing an offspring kills the larval creature. Someone other than the target the offspring is attached to can also perform this action. Anyone using a weapon to kill or remove an attached offspring deals half of the damage to the creature to which the offspring is attached. A bogwid can launch up to 10 offspring per day before it must rest and gestate more larval young.

Disease (Ex)

Bogwid Fever: Bite—injury; *save* Fortitude, Con-based DC, onset 1 day, frequency 1/day, effect 1d2 Str damage and shaken, cure 2 consecutive saves.

#### Carrion Moth

**Prerequisite(s)**: Elder Voice feat, Will +4
...
The flapping wings of a carrion moth emit a mind-numbing drone that affects all creatures within 80 feet that hear it. Affected creatures must succeed on a Will save or become confused for 2d4 rounds. A creature that successfully saves cannot be affected by the same carrion moth’s drone attack for 24 hours. The save DC is Constitution-based.

Stench (Ex)

When a carrion moth dies, its carcass splits open and releases a foul-smelling gas. All living creatures (except other carrion moths) within 5 feet of the carcass must succeed on a Fortitude save or be nauseated for 1d4+1 rounds. A delay poison or neutralize poison spell removes the effect from the nauseated creature. This is a poison effect. The save DC is Constitution-based.
...
A crawler can perform a special kind of pounce attack by jumping into combat. When a crawler charges, it can make a DC 20 Acrobatics check to jump into the air and land next to its enemies. If it makes the Acrobatics check, it can follow up with four claw attacks against foes in reach, but it cannot make a bite attack.

Plant Defenses (Ex)

A crawler is part plant and shares many of the immunities that plant creatures possess. A crawler is immune to mind-affecting effects, paralysis, poison, polymorph, sleep, and stunning.

Poison (Ex)

Bite—injury; *save* Fortitude, Con-based DC; *frequency* 1/round for 4 rounds; *effect* 1d2 Str and 1d2 Con; *cure* 1 save.
...
An enraged remorhaz generates heat so intense that anything touching its body takes 4d6 points of fire damage. Creatures striking a remorhaz with natural attacks or unarmed strikes are subject to this damage, but not creatures striking with melee weapons. The heat can melt or burn weapons any weapon that strikes a remorhaz is allowed a DC 19 Fortitude save to avoid taking damage. The save DC is Constitution-based.

Freeze (Ex)

While lying motionless with its mouth open, a geomaw appears to be a natural crystal formation. A geomaw that uses freeze can take 20 on its Stealth check to hide in plain sight as a natural cave feature.

Blood Lantern (Su)

As a swift action in any round it inflicts damage to a victim it has swallowed whole, a geomaw can emit a scintillating pattern of red-hued light from its crystalline interior. All creatures within 30 feet must succeed at a Will saving throw or be fascinated. This is a sight-based, mind-affecting compulsion effect. A creature that successfully saves cannot be affected by the same geomaw’s blood lantern for 24 hours. The save DC is Charisma-based.
...
A lunarma’s carapace is covered in jagged barbs. Any creature that grapples a lunarma or attacks it with unarmed strikes or natural weapons takes 1d4 (1d3 when it is Small) points of damage from the vicious barbs. Using a reach weapon does not endanger the attacker this way.

Breath Weapon (Su)

30-ft. line, 2d6 acid damage plus recurring damage, Reflex half, usable every 1d4 rounds.
...
When killed, the reefclaw spasms horribly making a full attack as an immediate action against a creature it threatens. If more than one creature is within reach, roll randomly for the target of each attack.

Grab (Ex)

A reefclaw can grab targets of any size, and has a +8 racial bonus on grapple checks rather than the normal +4 bonus.

Poison (Ex)

Claw-injury; *save* fortitude, Con-based DC; *frequency* 1/round for 4 rounds; *effect* 1d2 Str damage; *cure* 1 save
...
A salt worm may attack with its tail while attached to a victim.
...
A catoblepas’s horrid, stinking breath is 60-foot cone of poison gas. This breath weapon is usable once every 1d6 rounds. The save DC is Constitution-based.

**Breath**—contact; *save* Fortitude; *frequency* 1/round for 6 rounds; *effect* 1d4 Con damage; *cure* 2 consecutive saves.

Stench (Ex)

This functions as the universal monster ability, has a radius detailed above, and the DC is Constitution-based. The character is not affected by their own catoblepas’s stench.
...
A frost-ferret’s breath weapon deals the listed amount in cold damage in a cone. The length of the cone is listed in the entry above.

The breath weapon is usable once every 1d4 rounds, and allows a Reflex save for half damage. The save DC is Constitution-based.
...
Bite-injury; *save* Fortitude, Con-based DC; *onset* 1d3 days; *frequency* 1/day; *effect* 1d6 Str damage; *cure* 2 consecutive saves
...
If given 8 hours in a new environment, the mule-lizard can changed the colors and patterns in its skin to grant itself a +4 bonus on Stealth checks. Alternatively, the master of the mule lizard can provoke it to take on more flamboyant colors, basically taking on patterns and colors of the master’s choice but they lose the Stealth bonus.

#### Strong-legged (Ex)

The mule-lizard is bipedal but has stable, strong legs. They gain a +4 bonus on their CMD vs. bull-rush and trip. Additionally, they may carry loads as if they were a quadruped and may carry riders up to their size.
...
Ridge fliers have a preternatural ability to sense when a creature has entered their territory. A ridge flier gains a +20 bonus to Perception checks to notice the presence of a creature nearby. This only allows them to know there is a creature within 100 feet of them, they must make a standard Perception check (without the bonus) to pinpoint the intruder.

#### Hyper-aggression (Ex)

If a ridge flier can see a creature that they do not recognize as part of their flock or other individual they are trained to accept, there is a 10% chance every minute that they will fly into a rage and attack the invading creature. The ridge flier gains a +2 bonus to Strength and Constitution, a +8 bonus to Perception to find the target of its rage, and a -2 penalty to its AC. The rage lasts until the creature is dead or 1 minute, whichever is shorter. The ridge flier cannot end this rage voluntarily.

If the ridge flier enters a combat not already under the effects of the hyper-aggression, or the original target is killed during the combat, the chance that the ridge flier enters the rage is increased to 50% each round. The combat-induced rage is directed at a random qualifying target in sight.
...
Bloodfire fever: Bite—injury; *save* Fortitude; onset 1 day; *frequency* 1/day; *effect* 1d3 Str damage, 1d3 Dex damage, and target is fatigued; *cure* 2 consecutive saves. The save DC is Constitution-based.
...
### Other Magical Beast Companions

The following creatures can be chosen as Magical Beast companions by a character with the Monstrous Mount feat. Their entries and advancement are the same as for animal companions, with two exceptions. First, creatures with an Intelligence score of 3 or higher have one or more additional prerequisites the character must meet to select the companion. Second, each beast companion has a mastery ability that it can use only if the character it is bonded to has the Monstrous Mount Mastery feat. The minimum level to gain this ability is listed in parentheses. The save DC for any of a beast companion’s special abilities is 10 + half the beast companion’s HD + the beast companion’s Constitution modifier.
...
Shocking Tentacles (Ex)

A thundercloud jellyfish’s arms deliver electricity damage and a paralysis *effect* with a melee touch attack. The creature’s Strength modifier is used for the attack roll but is not added to damage. Additionally, when large size, the arms have a 10-foot reach. The arms are unable to grapple unless the target creature is 3 size categories smaller than the thundercloud Jellyfish. The arms are predominantly for bringing plant material to the mouth within the bell, not for picking up or wrapping around larger foes.
...
**Poison Bite**-injury or spit-contact; *save* fortitude, Conbased DC; *frequency* 1/round for 4 rounds; *effect* 1d2 Con damage, 1d2 Dex damage; *cure* 2 consecutive saves
...
### Animal Companions from Other Publishers

**Table: 3rd Party Publisher Animal Choices**

| Name | Size | Use for… | Terrain* | Source |
| --- | --- | --- | --- | --- |
| Ant, Riding | M |  | Any | JBE:CM |
| Cave Salamander | L |  | Any Underground | JBE:CM |
| Darkling Beetle, Giant | L |  | Any Underground | JBE:CM |
| Dodo, riding | L |  | Plane of Shadows | JBE:SFSPPC |
| Eagle, Riding | L |  |  | JBE:CM |
| Elk, Riding | L |  | Plains (temperate, cold) | JBE:CM |
| Gila Monster, Giant | M |  | Desert (warm) | JBE:CM |
| Hawk, Riding | M |  |  | JBE:CM |
| Nightcrawler, giant | S |  | Plane of Shadows | JBE:SFSPPC |
| Ostrich, Riding | L |  | Deserts or plains (warm) | JBE:CM |
| Shade Ferret | M |  | Plane of Shadows | JBE:SFSPPC |
| Spider, Riding |  |  | Any | JBE:CM |
| Tumble Pig | M |  | Plains | JBE:CM |
| Umbral Vulture | S |  | Plane of Shadows | JBE:SFSPPC |
| Wolfhound | L |  | Any | JBE:CM |
...
Once every 6 hours, the ankheg can spit a 30-foot line of acid. Creatures struck by this acid take 4d4 points of acid damage. A Reflex save halves the damage (save is Con based). Once used, the ankheg must wait 6 hours to be able to use it again. During the waiting period, the ankheg‘s bite loses its acid damage.
...
A bunnicorn can heal a creature of their choosing as a standard action by touching their horn to a target. They may use this ability a number of times equal to their Charisma modifier. They heal 1d6 hit points of damage per 2 HD they possess. They may not heal themself in this way.
...
#### Chikfari Poison Bite

**Type**: injury; *effect* 1 Con damage; *save* fortitude Con-based DC; *frequency* 1/round (6 rounds); *cure* 1 save

#### Devastating Kick

A chikfari’s massive rear legs are incredibly powerful (dealing +1 1/2 its Strength modifier in damage and having a critical multiplier of x3. Whenever a chikfari hits a target of its size or smaller, it may make a free bull rush attempt to knock the target away, though the chikfari cannot move with the target if it does.
...
A chimera’s breath weapon depends on the color of its dragon head, as summarized on the table below. Regardless of its type, a chimera’s breath weapon is usable once every 1d4 rounds, deals the damage listed in its advancement above, and allows a Reflex save for half damage. The save DC is Constitution-based.

The range of the breath weapon is listed in the advancements above. The first number is for lines, the second for cones. For example, the base chimera deals 2d6 with their breath weapon. If they are a black- or blue-dragon chimera, their breath weapon is a 20-foot line. Otherwise it is a 10-foot cone.

To determine a chimera’s head color and breath weapon randomly, roll 1d10 and consult the table below:

| d20 | Head Color | Breath Weapon |
| --- | --- | --- |
| 1-2 | Black | Line of acid |
| 3-4 | Blue | Line of lightning |
| 5-6 | Green | Cone of acid |
...
A hollow hound is constantly exuding a mist from their paws, tail and eyes. The cumulative mist that forms around them grants a constant 10% concealment. This concealment does not stack with the concealment granted by obscuring mist or similar spells or from natural fog or smoke.
...
An enraged remorhaz generates heat so intense that anything touching its body takes 4d6 points of fire damage. Creatures striking a remorhaz with natural attacks or unarmed strikes are subject to this damage, but not creatures striking with melee weapons. The heat can melt or burn weapons any weapon that strikes a remorhaz is allowed a DC 19 Fortitude save to avoid taking damage. The save DC is Constitution-based. When the remorhaz companion grows to large size, the fire damage increases to 6d6.
...
If a tazelwurm catches an opponent flat-footed it gains a +4 circumstance bonus to its attack roll for that round.
